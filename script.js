...
function addItem(item) {
  if (item === 1) {
    var el = document.querySelector("#merc");
    el.value = parseInt(el.value, 10) + 1;
    price = parseInt(document.querySelector("#price1").innerHTML, 10);
    document.querySelector("#price1").innerHTML = price + 51599;
    adjustPrices();
  } else if (item === 2) {
    var el = document.querySelector("#merc2");
    el.value = parseInt(el.value, 10) + 1;
    price = parseInt(document.querySelector("#price2").innerHTML, 10);
    document.querySelector("#price2").innerHTML = price + 65051;
    adjustPrices();
  } else if (item === 3) {
    var el = document.querySelector("#merc3");
    el.value = parseInt(el.value, 10) + 1;
    price = parseInt(document.querySelector("#price3").innerHTML, 10);
    document.querySelector("#price3").innerHTML = price + 36549;
    adjustPrices();
  } else {
